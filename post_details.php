		...
		<div class="col-md-6 col-md-offset-3 comments-section">
			...
			<?php if (isset($user_id)): ?>
				<form class="clearfix" action="post_details.php" method="post" id="comment_form">
					<textarea name="comment_text" id="comment_text" class="form-control" cols="50" rows="3"></textarea>
			...
			<?php if (isset($comments)): ?>
				...
				<div class="comment clearfix">
					...
					<form action="post_details.php" class="reply_form clearfix" id="comment_reply_form_<?php echo $comment['id'] ?>" data-id="<?php echo $comment['id']; ?>">
						<textarea class="form-control" name="reply_text" id="reply_text" cols="30" rows="10"></textarea>
							...
							<?php foreach ($replies as $reply): ?>
								...
								<div class="comment reply clearfix">
									...
									<div class="comment-details">
										...
										<a class="reply-btn" href="index.php">reply</a>
									</div>
								</div>
							<?php endforeach ?>
						<?php endif ?>
